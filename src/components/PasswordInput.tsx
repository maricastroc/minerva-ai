    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className={`w-full px-4 py-3 bg-white/5 border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:border-2 focus:border-primary-blue500 transition-colors pr-12 ${className} ${
