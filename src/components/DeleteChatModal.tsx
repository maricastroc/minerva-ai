    ...
    <Dialog.Root open={isOpen}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed z-[999] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90vw] bg-primary-gray600 rounded-3xl shadow-lg p-6 md:w-[370px]">
          <Dialog.Title className="text-lg font-semibold text-primary-gray25 mb-4">
            Delete chat?
          </Dialog.Title>

          <Dialog.Description className="flex flex-col w-full">
            <p className="text-sm font-medium text-primary-gray25">
            ...
            <div className="mt-6 flex items-end justify-end w-full gap-2">
              <button
                disabled={isLoading}
                onClick={onClose}
                className="cursor-pointer font-semibold rounded-3xl p-2 px-4 flex items-center gap-2 transition-all duration-300 max-h-[60px] text-sm bg-transparent border border-primary-gray400 text-primary-gray25 hover:bg-white/10 capitalize justify-center disabled:bg-gray-400 disabled:text-primary-gray25 disabled:cursor-not-allowed"
              >
                Cancel
              </button>
              <button
